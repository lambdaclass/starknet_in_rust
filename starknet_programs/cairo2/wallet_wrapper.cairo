...
trait IWalletWrapper<TContractState> {
    fn get_balance(ref self: TContractState, simple_wallet_contract_address: starknet::ContractAddress) -> felt252;
...
mod WalletWrapper {
    ...
    //     fn get_balance(ref self: ContractState, simple_wallet_contract_address: ContractAddress) -> felt252 {
