...
pub(crate) struct CallInfo {
    ...
    _storage_read_values: VecDeque<u64>, // U32
...
pub(crate) struct OsSyscallHandler {
    ...
    deployed_contracts_iterator: VecDeque<u64>, // U32
    // An iterator to the retdata of its internal calls.
    retdata_iterator: VecDeque<VecDeque<u64>>, //VEC<U32>
    // An iterator to the read_values array which is consumed when the transaction
    // code is executed.
    execute_code_read_iterator: VecDeque<u64>, //u32
