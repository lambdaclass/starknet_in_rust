...
fn internal_deploy_account() {
    ...
    let contract_class = ContractClass::try_from(PathBuf::from("tests/syscalls.json")).unwrap();
    ...
    let internal_deploy_account = InternalDeployAccount::new(
        ...
        0,
        vec![felt_str!(
            "2612640184215060329973671567201105979048071207288945836837601213263070089980"
        )],
        vec![
            felt_str!(
